...
1. **Confusing Navigation:** Users were unsure how to return to the property listings after clicking on a specific listing. There was no clear “Back to Results” option.
2. **Unclear Price Breakdown:** The wireframe showed the total price but did not include a detailed breakdown of nightly rates, cleaning fees, or service charges.
3. **Overloaded Booking Form:** The checkout screen had too many input fields shown at once, which overwhelmed users and led to drop-offs during testing.

### Resolutions Based on Wireframing Feedback:

- A persistent navigation bar was added with a visible “Back to Search” button.
- A transparent price breakdown was introduced directly below the total cost, making the charges clear before payment.
- The booking form was redesigned into multiple steps (progressively disclosed), showing only necessary fields at each step.
These changes were made directly in the wireframe using Figma before any code was written, which saved time and prevented costly revisions during development.

### Impact on the Final Product:

- Users reported smoother navigation and better understanding of costs during user testing.
- The multi-step booking form improved completion rates significantly.
- Developers had a clear structure to follow, which accelerated implementation and reduced back-and-forth revisions.
